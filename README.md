...
### Keep in mind:
* The Wiki may have the answer you are looking for https://github.com/Zuxces
...
After the bot has joined your server, use ```{prefix}help``` to display help and command information.
